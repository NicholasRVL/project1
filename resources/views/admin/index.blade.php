...
<div class="shadow-sm py-2 mb-3 rounded-2 p-2" style="margin: 0; width: 100%; background-color: rgb(224, 231, 236); display: flex; ">
        ...
        <h1 class="m-3" style="color: rgb(120, 154, 187); font-family: Raleway;">Adm Home</h1>
    ...
    <div class="d-flex shadow-sm" style="height: max-content; background-color: rgba(244, 247, 247, 0.719);" >
        ...
        <div class="button-item p-2" style="height: max-content">
             <a href="/listadm" class="  shadow-sm rounded-2 icon-link icon-link-hover justify-content-center align-item-center p-4" id="delete-notes" style="min-height: max-content; width: 17vh; background-color: rgb(230, 188, 188); --bs-icon-link-transform: translate3d(0, -.125rem, 0);">
        ...
        <div class="button-item p-2" style="height: max-content">
            <a href="/listuser" class="  shadow-sm rounded-2 icon-link icon-link-hover justify-content-center align-item-center p-4" id="edit-notes" style="min-height: max-content; width: 17vh; background-color: rgb(230, 224, 176); --bs-icon-link-transform: translate3d(0, -.125rem, 0);">
